...
- [x] **4.4** Migrar `window.__*` a event delegation (admin/users.astro, trainer/workouts.astro, trainer/diets.astro)
- [x] **4.5** Reemplazar `confirm()` con modal (ConfirmModal.astro + showConfirm global)
