...
export function parseExercisesSource(source: string | object[]): ParsedSeedBatch<ExerciseItem> {
  ...
  for (let idx = 0; idx < rawItems.length; idx++) {
    ...
    const exerciseItem: ExerciseItem = {
      ...
      difficultyLevel: (raw.difficultyLevel ? Number(raw.difficultyLevel) : (raw.difficulty === 'advanced' ? 5 : raw.difficulty === 'intermediate' ? 3 : 1)) as 1 | 2 | 3 | 4 | 5,
      ...
      videoUrl: raw.videoUrl || raw.video || 'https://www.youtube.com/watch?v=rT7DgCr-3pg',
